 ...
 */
 /*
    ...
    * 테이블 생성
    - 테이블이란? 행(ROW)과 열(COLUMN)로 구성되는 가장 기본적인
                  데이터베이스 객체
...
INSERT INTO MEM_NOTNULL VALUES(1, 'user01', 'pass01', '홍길동',
                                '남', null, null);

INSERT INTO MEM_NOTNULL VALUES(2, 'user02', NULL, '김말순',
                                '여', null, 'aaa@naver.com');
...
INSERT INTO MEM_UNIQUE VALUES(2, 'user01', 'pass02', '강개똥',
                                null, null, null);
...
INSERT INTO MEM_PRI VALUES(1, 'user01', 'pass01', '강개순', '여',
                            '010-1111-2222', null);

INSERT INTO MEM_PRI VALUES(1, 'user02', 'pass02', '이순신', '남',
                            null, null);
--> 기본키 중복값을 담으려고 할 때 (unique 제약조건 위배)    

INSERT INTO MEM_PRI VALUES(null, 'user02', 'pass02', '이순신', '남',
                            null, null);
--> 기본키 null을 담으려고 할 때 (not null 제약조건 위배)   

INSERT INTO MEM_PRI VALUES(2, 'user02', 'pass02', '이순신', '남',
                            null, null);
...
INSERT INTO MEM_PRI2 VALUES(1, 'user01', 'pass01', '홍길동', 
                                null, null, null);
INSERT INTO MEM_PRI2 VALUES(1, 'user02', 'pass02', '홍길녀', 
                                null, null, null);

-- 복합키 사용 예시 (어떤 회원이 어떤 상품을 찜하는지에 대한 데이터를
--                  보관하는 테이블)
...
/*
    DEFAULT 기본값
    - 제약조건 아님!
    - 컬럼을 선정하지 않고 INSERT시 NULL이 아닌 기본값을
...
CREATE TABLE TB_BOOK(
    ...
    CONSTRAINT TB_BOOK_BK_PUB_NO FOREIGN KEY(BK_PUB_NO) 
                            REFERENCES TB_PUBLISHER ON DELETE CASCADE
);
INSERT INTO TB_BOOK VALUES(1, '프로그래머 열정을 말하다', '채드 파울러', 12600, 1);
INSERT INTO TB_BOOK VALUES(1, '1일 1로그 100일 완성 IT 지식', '브라이언', 18000, 1);
INSERT INTO TB_BOOK VALUES(1, '인스파이어드', '마티 케이건', 21600, 2);
INSERT INTO TB_BOOK VALUES(1, '혼자 공부하는 얄팍한 코딩 지식', '고현민', 16200, 3);
INSERT INTO TB_BOOK VALUES(1, '함께 자라기', '김창준', 11700, 1);
...
CREATE TABLE TB_RENT(
    ...
    CONSTRAINT TB_RENT_RENT_BOOK_NO_FK FOREIGN KEY(RENT_BOOK_NO)
                            REFERENCES TB_BOOK ON DELETE SET NULL                        
);
