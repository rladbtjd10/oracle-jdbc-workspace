...
CREATE TABLE RES_COMMENT(
    ...
    RES_PARENT_COMMENT VARCHAR2(300),
    ID VARCHAR2(20),
    REVIEW_CODE NUMBER
);
...
--    MEM_ID VARCHAR2(200), -- 일단 만들어놓음
    ...
    PARANTS_RES_COMMENT_SEQ VARCHAR2(200),
    ID VARCHAR2(20),
    RES_CODE NUMBER
);
CREATE TABLE PHOTO(
...
ALTER TABLE RESTAURANT ADD CONSTRAINT RESTAURANT_MENU_CODE_FK FOREIGN KEY(MENU_CODE) REFERENCES MENU;
...
INSERT INTO PICK(PICK_CODE, RES_CODE, ID) VALUES(SEQ_PICK.NEXTVAL,'1', '1');
​
​
SELECT * FROM PICK;
