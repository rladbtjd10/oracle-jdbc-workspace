 ...
 */
 ...
 -- PL/SQL에서 EMP_DOPY 테이블에 BONUS가 NULL인 사원의 BONUS를 0으로 수정
 BEGIN
        UPDATE EMP_COPY
        SET BONUS = 0
        WHERE BONUS IS NULL;
...
-- 전체 부서에 대해 부서코드, 부서명, 지역 조회 (CURSOR와 PL/SQL을 사용해서!)
DECLARE
